...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"],
            ["channel_v3.id"],
            name=op.f("fk_different_users_v3_channel_id_channel_v3"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_different_users_v3")),
    )
    op.create_index(
        op.f("ix_different_users_v3_channel_id"),
        "different_users_v3",
        ["channel_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_different_users_v3_period_start"),
        "different_users_v3",
        ["period_start"],
        unique=False,
    )
    ...
    op.create_table(
        "time_spent_by_foreground_app_v3",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("absolute_timestamp", sa.BigInteger(), nullable=False),
        sa.Column("relative_timestamp", sa.BigInteger(), nullable=False),
        sa.Column("os_version", sa.Unicode(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"],
            ["channel_v3.id"],
            name=op.f("fk_time_spent_by_foreground_app_v3_channel_id_channel_v3"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_time_spent_by_foreground_app_v3")),
    )
    op.create_index(
        op.f("ix_time_spent_by_foreground_app_v3_channel_id"),
        "time_spent_by_foreground_app_v3",
        ["channel_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_time_spent_by_foreground_app_v3_period_start"),
        "time_spent_by_foreground_app_v3",
        ["period_start"],
        unique=False,
    )
    op.create_table(
        "time_spent_in_session_v3",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("absolute_timestamp", sa.BigInteger(), nullable=False),
        sa.Column("relative_timestamp", sa.BigInteger(), nullable=False),
        sa.Column("os_version", sa.Unicode(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"],
            ["channel_v3.id"],
            name=op.f("fk_time_spent_in_session_v3_channel_id_channel_v3"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_time_spent_in_session_v3")),
    )
    op.create_index(
        op.f("ix_time_spent_in_session_v3_channel_id"),
        "time_spent_in_session_v3",
        ["channel_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_time_spent_in_session_v3_period_start"),
        "time_spent_in_session_v3",
        ["period_start"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_time_spent_in_session_v3_period_start"),
        table_name="time_spent_in_session_v3",
    )
    op.drop_index(
        op.f("ix_time_spent_in_session_v3_channel_id"),
        table_name="time_spent_in_session_v3",
    ...
    op.drop_index(
        op.f("ix_time_spent_by_foreground_app_v3_period_start"),
        table_name="time_spent_by_foreground_app_v3",
    )
    op.drop_index(
        op.f("ix_time_spent_by_foreground_app_v3_channel_id"),
        table_name="time_spent_by_foreground_app_v3",
    ...
    op.drop_index(
        op.f("ix_different_users_v3_period_start"), table_name="different_users_v3"
    )
    op.drop_index(
        op.f("ix_different_users_v3_channel_id"), table_name="different_users_v3"
    )
